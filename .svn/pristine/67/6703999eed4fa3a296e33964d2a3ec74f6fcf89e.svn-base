...
namespace jQuery_File_Upload.MVC3.Upload
{
    public class FilesStatus
    {
        ...
        public FilesStatus(string fileName, int fileLength, string fullPath, string id = "", string relativeUrlPath = "") { SetValues(fileName, fileLength, fullPath, id, relativeUrlPath); }

        private void SetValues(string fileName, int fileLength, string fullPath, string id = "", string relativeUrlPath = "")
        {
            name = fileName;
            type = "image/png";
            size = fileLength;
            ...
            delete_type = "DELETE";
            pathattachment = relativeUrlPath;
            idemail = id;
